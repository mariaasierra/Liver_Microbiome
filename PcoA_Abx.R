setwd("~/Desktop/Kylin/Josh/09_19_2018/old_res/analysis/Box6/")
source("~/Desktop/Kylin/scripts/microbiome_functions.R")

#Beta Diverstiy Antibiotics Suppl Fig S3
phylo <- import_data("otu_table.biom", mapping = "mapping_file.txt", tree = "rep_set_filtered.tre")
